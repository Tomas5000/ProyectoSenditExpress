...
<html>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Inventario inicial" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Inventario final" disabled></th>
                    </tr>
                </thead>
                <tbody>
   ...
   <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    ...
    <script src ="<?php echo URL_BASE."/public/js/bootstrap.min.js";?>"
    type="text/javascript" charset = "utf-8" async defer></script>

     <script src ="<?php echo URL_BASE."/public/js/custom.js";?>"
    type="text/javascript" charset = "utf-8" async defer></script>
