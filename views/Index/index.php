...
<head>
    ...
    <title>Empresa SendItExpress</title>
...
<header>
<img src="http://pulsodevidaecuador.com/wp-content/uploads/2015/05/Logo-camion-envio.png"/>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">SendItExpress</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="<?php echo URL_BASE."/index.php/operador/listarOperador"?>">Mostar Operadores</a>
                    </li>


                    <li class="page-scroll">
                        <a href="PaginaPrincipal.html" >Cerrar Sesion</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
